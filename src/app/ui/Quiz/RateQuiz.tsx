...
export default function RateQuiz({ data }: { data: IQuiz }) {
  ...
  return (
    <section className="mt-[40px]  max-md:max-w-[300px]  items-center flex flex-col gap-[30px]">
      <div className=" flex flex-col gap-10 items-center">
        <h2 className="text-xl w-[400px] max-lg:w-[300px]  font-bold">
          {data.question}
        </h2>
        ...
        <div>
          <div className="flex flex-col gap-2  items-center">
            ...
            <div className="text-gray-700 w-1/1  max-lg:w-1/1 flex justify-between">
              <p>Not hard</p>
              <p>Very hard</p>
            </div>
          </div>
