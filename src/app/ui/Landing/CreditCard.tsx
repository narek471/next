...
export default function CreditCard() {
  ...
  const [amount, setAmount] = useState([
    ...
    ["61% introductory price discount", "-19.01 USD"],
    ["11.99 USD"],
    ["per 1 month", "You just saved 19.01 USD (61% off)"],
  ]);
  ...
  useEffect(() => {
    if (selectedPlan == 0) {
      setAmount([
        ...
        ["61% introductory price discount", "-5.09 USD"],
        ["5.50 USD"],
        ["per 1 week", "You just saved 5.09 USD (48% off)"],
      ]);
      ...
      setAmount([
        ...
        ["61% introductory price discount", "-31.55 USD"],
        ["21.49 USD"],
        ["per 3 months", "You just saved 31.55 USD (60% off)"],
      ]);
    }
  }, [selectedPlan]);
    ...
    <div className="mt-[40px]">
      <div className="border-t-1 flex flex-col gap-2 pt-[10px] pb-[10px] border-b-1 border-[#f1f3f9]">
        ...
        <p className="text-[#11111380] text-[14px] flex justify-between items-center">
          ...
          <span className="text-[#e44240] font-bold">{amount[1][1]}</span>
        </p>
      </div>
      <div className="flex flex-col gap-2 pt-[10px] pb-[10px] ">
        ...
        <p className="flex justify-between text-[12px] font-bold">
          ...
          <span className="text-[#e44240] font-bold">{amount[3][1]}</span>
        </p>
      </div>
