...
import diagramm from "../../../../public/EN_img_sex_duration_7x.webp";
import corrected from "../../../../public/corrected.svg";
import SU from "../../../../public/SU.svg";
export default function EffectiveExercises3() {
  return (
    <section className="flex items-center w-[550px] max-lg:w-[300px] mt-[50px] flex-col gap-6">
      ...
      <h2 className="font-bold  text-center text-[20px] text-white">
        ...
        muscles, which significantly increases
        <span className="text-[#53cc58]">ejaculation control</span>{" "}
      </h2>
      <Image
        src={diagramm}
