...
export default function BasedGoals2() {
    const [slice, setSlice] = useState(3);

    // Получаем дату + 1 месяц + 10 дней
    ...
    return (
        <section className="flex items-center max-md:max-w-[320px] flex-col gap-6">
            ...
            <p className="text-[15px]">
                Improve <span className="font-bold">Ejaculation Control</span>
            </p>
            <p className="text-xl text-[#5773d6] font-bold">by {formattedDate}</p>
            <video
